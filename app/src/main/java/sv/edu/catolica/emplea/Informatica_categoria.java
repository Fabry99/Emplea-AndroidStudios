...
public class Informatica_categoria extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_informatica_categoria);
        init();
        ...
        View fondoLayout = findViewById(R.id.cat_informatica);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                if (item.getItemId() == R.id.nav_home) {
                    Intent intent = new Intent(Informatica_categoria.this, inicioofertas.class);
                    startActivity(intent);
                } else if (item.getItemId() == R.id.nav_salir) {
                    Intent intent = new Intent(Informatica_categoria.this, login.class);
    ...
    public static class MyVolleyRequest {
        ...
        public static void obtenerDatosDesdeServidor(Context context, final Informatica_categoria.MyVolleyRequest.VolleyCallback callback) {
            String url = "http://192.168.162.1/emplea/caT_informatica.php";
    ...
    public void init() {
        Informatica_categoria.MyVolleyRequest.obtenerDatosDesdeServidor(this, new Informatica_categoria.MyVolleyRequest.VolleyCallback() {
            @Override
            public void onSuccess(JSONArray result) {
                elements = parseJSONArray(result);

                adaptador = new adaptador(elements, Informatica_categoria.this);
                RecyclerView recyclerView = findViewById(R.id.listRecyclerViewInformatica);
                recyclerView.setHasFixedSize(true);
                recyclerView.setLayoutManager(new LinearLayoutManager(Informatica_categoria.this));
                recyclerView.setAdapter(adaptador);
            }

            @Override
            public void onError(String error) {
                Toast.makeText(Informatica_categoria.this, "Error: " + error, Toast.LENGTH_SHORT).show();
            }
        });
    }
