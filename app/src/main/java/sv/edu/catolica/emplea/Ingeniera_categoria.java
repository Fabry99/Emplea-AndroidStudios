...
public class Ingeniera_categoria extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ingeniera_categoria);
        init();
        ...
        View fondoLayout = findViewById(R.id.cate_ing);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                if (item.getItemId() == R.id.nav_home) {
                    Intent intent = new Intent(Ingeniera_categoria.this, inicioofertas.class);
                    startActivity(intent);
                } else if (item.getItemId() == R.id.nav_salir) {
                    Intent intent = new Intent(Ingeniera_categoria.this, login.class);
    ...
    public void init() {
        MyVolleyRequest.obtenerDatosDesdeServidor(this, new MyVolleyRequest.VolleyCallback() {
            @Override
            public void onSuccess(JSONArray result) {
                elements = parseJSONArray(result);

                adaptador = new adaptador(elements, Ingeniera_categoria.this);
                RecyclerView recyclerView = findViewById(R.id.listRecyclerViewIng);
                recyclerView.setHasFixedSize(true);
                recyclerView.setLayoutManager(new LinearLayoutManager(Ingeniera_categoria.this));
                recyclerView.setAdapter(adaptador);
            }

            @Override
            public void onError(String error) {
                Toast.makeText(Ingeniera_categoria.this, "Error: " + error, Toast.LENGTH_SHORT).show();
            }
        });
    }
